...
class SongDatabase:
    ...
    def index_song(self, filepath, song_name=None):
        ...
        for hash_val, time_offset in fingerprints:
            self.table.insert(hash_val, (song_id, time_offset))
        print(f"Indexed '{song_name}' with ID {song_id} and {len(fingerprints)} fingerprints.")
        return song_id
    ...
    def index_directory(self, directory):
        ...
        print(f"Indexed {len(wav_files)} songs from '{directory}'.")
    # ------------------------------------------------------------------ #
    ...
    def save(self, filepath):
        ...
        print(f"Database saved to '{filepath}' with {len(entries)} entries.")
